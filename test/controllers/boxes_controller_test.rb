...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post boxes_url, params: { box: { description: @box.description, image_data: @box.image_data, indicator: @box.indicator, user_id: @box.user_id } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { description: @box.description, image_data: @box.image_data, indicator: @box.indicator, user_id: @box.user_id } }
